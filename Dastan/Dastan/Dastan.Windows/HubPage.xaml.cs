...
namespace Dastan
{
    ...
    public sealed partial class HubPage : Page
    {
        ...
        private async void NavigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            ...
            this.DefaultViewModel["Section1Items"] = sampleDataGroup1;
        ...
        void ItemView_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            Load.currentItem.title = ((SampleDataItem)e.ClickedItem).Title;
            Load.currentItem.content = Load.dastans[((SampleDataItem)e.ClickedItem).Title];
        }
